...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
        ...
        var purpose = readData("purpose");
        var products = readData("products")
        var ease = readData("ease");
        var scale = readData("scale");
        var likely = readData("likely");
        res.render('showResults', {results: [colors,likely,ease,purpose,products,scale]});
        console.log([colors,purpose,products,ease,scale]);
    });
